...
class PwaPushForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['icon']['settings']['icon_upload'] = [
      ...
      '#maxlength' => 40,
      '#description' => $this->t("Upload advanced_pwa notification icon. Maximum allowed image dimensions is 144 x 144. If image with larger dimensions is submitted then it will be resized to 144 * 144"),
