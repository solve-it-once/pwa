...
class PwaPushSubscriptionForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['activate_feature'] = [
      ...
      '#description' => $this->t('Notifications will be pushed for published contentt'),
    ];
    ...
    $form['messages_settings']['insert_node_data'] = [
      ...
      '#description' => $this->t('Choose this option if you want send the title and summary from the node.'),
    ];
